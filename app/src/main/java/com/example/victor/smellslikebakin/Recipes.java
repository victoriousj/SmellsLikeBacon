...
public class Recipes {
    public static String[] names = new String[]{
            "Crepes","Pancakes","Scones","French Toast", "Muffins", "Waffles","Toast", "Banana Bread"
            ,"German Pancakes","Beignets", "Blintzes", "Croissants", "Biscuits", "Cinnamon Rolls",
            "Coffee Cake", "Donut Holes", "Bagels", "English Muffin", "Baguette", "Danish"
    };

    public static int[] resourceIds = new int[]{
            R.drawable.crepes, R.drawable.pancakes, R.drawable.scones, R.drawable.french_toast,
            R.drawable.muffins, R.drawable.waffles, R.drawable.toast, R.drawable.banana_bread,
            R.drawable.german_pancakes,
            R.drawable.beignets, R.drawable.blintzes, R.drawable.croissants, R.drawable.biscuits,
            R.drawable.cinnamon_rolls,
            R.drawable.coffee_cake, R.drawable.donut_holes, R.drawable.bagels, R.drawable.cupcakes,
            R.drawable.baguette, R.drawable.danish
    };
    ...
    public static String[] ingredients = new String[]{
            ...
            "4 tbsp butter (melt in pan)`2 cups milk`4 eggs`1 tsp vanilla extract`1 1/3 cup all-purpose flour`4 tbsp sugar`syrup, powdered sugar, lemon juice optional`",
            "lorem ipsum dolor sit amet`consectetur adipiscing elit`curabitur rhoncus interdum consequat",
            "lorem ipsum dolor sit amet`consectetur adipiscing elit`curabitur rhoncus interdum consequat",
            "lorem ipsum dolor sit amet`consectetur adipiscing elit`curabitur rhoncus interdum consequat",
            "lorem ipsum dolor sit amet`consectetur adipiscing elit`curabitur rhoncus interdum consequat",
            "lorem ipsum dolor sit amet`consectetur adipiscing elit`curabitur rhoncus interdum consequat",
    ...
    public static String[] directions = new String[]{
            ...
            "Preheat oven to 400 degrees. Place 9x13 dish with 4 tbsp butter in oven while preheating.`Once butter is melted, remove dish. Combine remaining ingredients in blender.`Pour batter into the dish, over the melted butter.`Place dish back in oven and cook for 20 minutes or until  edges are puffy and golden brown.`Serve hot and enjoy with syrup, powdered sugar, and/or lemon juice sprinkled over top.",
            "Morbi consectetur cursus risus eget porta.`Sociis natoque penatibus et magnis dis parturient montes`nascetur ridiculus mus`Nullam ac felis at nisl pretium aliquam`sed malesuada elit quis velit dapibus tristique`Mauris sed finibus urna. Ut sed rutrum ex`Lorem ipsum dolor sit amet`Consectetur adipiscing elit. Phasellus tristique commodo auctor.`Donec in magna eget erat ornare malesuada et sed ipsum. Nunc tempus, quam ut maximus feugiat.",
            "Morbi consectetur cursus risus eget porta.`Sociis natoque penatibus et magnis dis parturient montes`nascetur ridiculus mus`Nullam ac felis at nisl pretium aliquam`sed malesuada elit quis velit dapibus tristique`Mauris sed finibus urna. Ut sed rutrum ex`Lorem ipsum dolor sit amet`Consectetur adipiscing elit. Phasellus tristique commodo auctor.`Donec in magna eget erat ornare malesuada et sed ipsum. Nunc tempus, quam ut maximus feugiat.",
            "Morbi consectetur cursus risus eget porta.`Sociis natoque penatibus et magnis dis parturient montes`nascetur ridiculus mus`Nullam ac felis at nisl pretium aliquam`sed malesuada elit quis velit dapibus tristique`Mauris sed finibus urna. Ut sed rutrum ex`Lorem ipsum dolor sit amet`Consectetur adipiscing elit. Phasellus tristique commodo auctor.`Donec in magna eget erat ornare malesuada et sed ipsum. Nunc tempus, quam ut maximus feugiat.",
            "Morbi consectetur cursus risus eget porta.`Sociis natoque penatibus et magnis dis parturient montes`nascetur ridiculus mus`Nullam ac felis at nisl pretium aliquam`sed malesuada elit quis velit dapibus tristique`Mauris sed finibus urna. Ut sed rutrum ex`Lorem ipsum dolor sit amet`Consectetur adipiscing elit. Phasellus tristique commodo auctor.`Donec in magna eget erat ornare malesuada et sed ipsum. Nunc tempus, quam ut maximus feugiat.",
            "Morbi consectetur cursus risus eget porta.`Sociis natoque penatibus et magnis dis parturient montes`nascetur ridiculus mus`Nullam ac felis at nisl pretium aliquam`sed malesuada elit quis velit dapibus tristique`Mauris sed finibus urna. Ut sed rutrum ex`Lorem ipsum dolor sit amet`Consectetur adipiscing elit. Phasellus tristique commodo auctor.`Donec in magna eget erat ornare malesuada et sed ipsum. Nunc tempus, quam ut maximus feugiat.",
